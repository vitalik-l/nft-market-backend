...
export interface ApiChainChain extends Schema.CollectionType {
  ...
  attributes: {
    ...
    scannerUrl: Attribute.String & Attribute.Required;
    chainId: Attribute.String & Attribute.Required & Attribute.Unique;
    config: Attribute.Relation<
      'api::chain.chain',
      'oneToOne',
      'api::chain-config.chain-config'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiChainConfigChainConfig extends Schema.CollectionType {
  collectionName: 'chain_configs';
  info: {
    singularName: 'chain-config';
    pluralName: 'chain-configs';
    displayName: 'Chain Config';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    usdcAddress: Attribute.String;
    usdtAddress: Attribute.String;
    alchemyApiKey: Attribute.String;
    walletConnectProjectId: Attribute.String;
...
export interface ApiItemItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Relation<
      ...
      'api::category.category'
    >;
    chain: Attribute.Relation<'api::item.item', 'oneToOne', 'api::chain.chain'>;
    slug: Attribute.String & Attribute.Required & Attribute.Unique;
    contents: Attribute.Relation<
      'api::item.item',
      'oneToMany',
      'api::item-content.item-content'
    >;
    modelFile: Attribute.Media;
...
export interface ApiItemContentItemContent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    descriptionShort: Attribute.Text &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::chain-config.chain-config': ApiChainConfigChainConfig;
      'api::faq.faq': ApiFaqFaq;
      'api::item.item': ApiItemItem;
      'api::item-content.item-content': ApiItemContentItemContent;
    }
  }
}
